...
# D = DetectBirds("../dataset/videos/A003_02011701_C010.mp4")
D = DetectBirds("../dataset/Personal_videos/videos/VID_20211111_135050.mp4")
# D = DetectBirds("../dataset/videos/birds.mp4")
D.detect()